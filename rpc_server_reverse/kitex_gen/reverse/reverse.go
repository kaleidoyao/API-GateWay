...
type ReverseResponse struct {
	OutputString string `thrift:"outputString,1,required" frugal:"1,required,string" json:"outputString"`
}
...
func (p *ReverseResponse) SetOutputString(val string) {
	p.OutputString = val
}
...
func (p *ReverseResponse) DeepEqual(ano *ReverseResponse) bool {
	...
	if !p.Field1DeepEqual(ano.OutputString) {
		return false
	}
	return true
}
...
func (p *ReverseResponse) Field1DeepEqual(src string) bool {
	...
	if strings.Compare(p.OutputString, src) != 0 {
		return false
	}
	return true
}
...
type ReverseServiceReverseMethodArgs struct {
	Request *ReverseRequest `thrift:"request,1" frugal:"1,default,ReverseRequest" json:"request"`
}
...
func (p *ReverseServiceReverseMethodArgs) InitDefault() {
	*p = ReverseServiceReverseMethodArgs{}
}
...
func (p *ReverseServiceReverseMethodArgs) SetRequest(val *ReverseRequest) {
	p.Request = val
}
...
func (p *ReverseServiceReverseMethodArgs) DeepEqual(ano *ReverseServiceReverseMethodArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ReverseServiceReverseMethodArgs) Field1DeepEqual(src *ReverseRequest) bool {
...
func (p *ReverseServiceReverseMethodResult) InitDefault() {
	*p = ReverseServiceReverseMethodResult{}
}
...
func (p *ReverseServiceReverseMethodResult) SetSuccess(x interface{}) {
...
func (p *ReverseServiceReverseMethodResult) DeepEqual(ano *ReverseServiceReverseMethodResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *ReverseServiceReverseMethodResult) Field0DeepEqual(src *ReverseResponse) bool {
