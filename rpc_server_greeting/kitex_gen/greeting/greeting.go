...
func (p *GreetingRequest) InitDefault() {
	*p = GreetingRequest{}
}
...
func (p *GreetingRequest) SetName(val string) {
	p.Name = val
}
...
func (p *GreetingRequest) DeepEqual(ano *GreetingRequest) bool {
	if p == ano {
		return true
...
func (p *GreetingRequest) Field1DeepEqual(src string) bool {
...
func (p *GreetingResponse) InitDefault() {
	*p = GreetingResponse{}
}
...
func (p *GreetingResponse) SetResponseBody(val string) {
	p.ResponseBody = val
}
...
func (p *GreetingResponse) DeepEqual(ano *GreetingResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GreetingResponse) Field1DeepEqual(src string) bool {
...
type GreetingServiceGreetingMethodArgs struct {
	Request *GreetingRequest `thrift:"request,1" frugal:"1,default,GreetingRequest" json:"request"`
}
...
func (p *GreetingServiceGreetingMethodArgs) InitDefault() {
	*p = GreetingServiceGreetingMethodArgs{}
}
...
func (p *GreetingServiceGreetingMethodArgs) SetRequest(val *GreetingRequest) {
	p.Request = val
}
...
func (p *GreetingServiceGreetingMethodArgs) DeepEqual(ano *GreetingServiceGreetingMethodArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GreetingServiceGreetingMethodArgs) Field1DeepEqual(src *GreetingRequest) bool {
...
type GreetingServiceGreetingMethodResult struct {
	Success *GreetingResponse `thrift:"success,0,optional" frugal:"0,optional,GreetingResponse" json:"success,omitempty"`
}
...
func (p *GreetingServiceGreetingMethodResult) InitDefault() {
	*p = GreetingServiceGreetingMethodResult{}
}
...
func (p *GreetingServiceGreetingMethodResult) SetSuccess(x interface{}) {
	p.Success = x.(*GreetingResponse)
}
...
func (p *GreetingServiceGreetingMethodResult) DeepEqual(ano *GreetingServiceGreetingMethodResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *GreetingServiceGreetingMethodResult) Field0DeepEqual(src *GreetingResponse) bool {
