...
type CalculateResponse struct {
	Outcome int32 `thrift:"outcome,1" frugal:"1,default,i32" json:"outcome"`
}
...
func (p *CalculateResponse) SetOutcome(val int32) {
	p.Outcome = val
}
...
func (p *CalculateResponse) Field1DeepEqual(src int32) bool {
